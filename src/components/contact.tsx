...
import { Github, Mail, MapPin, Phone, Facebook } from "lucide-react"
      ...
      <div className="container px-4 md:px-6">
        <div className="flex flex-col items-center justify-center space-y-4 text-center">
          <div className="space-y-2">
            <div className="inline-block rounded-lg bg-[#2BA6FF] px-3 py-1 text-sm text-white">Contact</div>
          ...
          <div className="space-y-6">
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="flex items-center gap-3">
                  <Facebook className="h-5 w-5 text-[#2BA6FF]" />
                  <Link
                ...
                <div className="flex items-center gap-3">
                  <MapPin className="h-5 w-5 text-[#2BA6FF]" />
            ...
            <Card>
              ...
              <CardContent>
                <div className="flex gap-4">
                  ...
                  <Button variant="outline" size="icon" asChild>
                    <Link href="https://fb.com/lthloi" target="_blank" rel="noopener noreferrer" aria-label="Facebook">
